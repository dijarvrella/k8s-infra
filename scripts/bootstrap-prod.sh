...
VALUES_FILE="$REPO_ROOT/operators/argocd/values-prod.yaml"
...
echo "   - Make sure you've configured your GitHub OAuth App and updated values-prod.yaml"
echo "   - OAuth callback URL should be: https://argocd.app.morichalcorp.com/api/auth/callback"
